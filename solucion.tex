...
\pred{posicionesVivas}{t : \toroide, vivas: \TLista{\ent x \ent}}{\\
    ...
    |vivas| > 0 \wedge (\forall i: \ent)(
     (0 \leq i < |vivas| ) \wedge \\ ((0 \leq vivas[i]_0 < |t| \land_L 0 \leq vivas[i]_1 < |t[0]|) \implicaLuego (t[vivas[i]_0][vivas[i]_1] = \True)))\\
    }
\vspace{5mm}
...
\begin{proc}{enCrecimiento}{in t: $\toroide$, out res: $\bool$}{}
    ...
    \post{res = \True \Iff (\exists tEvo, tMenor: \toroide)(\\
        ...
        esTraslado(t, tMenor) \wedge estaCreciendo(t, tMenor, tEvo)
    )
}
\end{proc}
...
\pred{coincideTamanio}{t:toroide, tAux:toroide}{\\esValido(t) \wedge esValido(tAux) \wedge |t| = |tAux| \yLuego |t[0]| = |tAux[0]|}
\vspace{5mm}
    ...
    (\exists \ s:\TLista{\toroide})(
        ...
        (\exists \ tMenor:\toroide)( 
            ...
            (\exists \ mat:\matriz{\bool})(
                ...
                (\forall tItem \in ts)(
                    tItem \neg tMenor \implicaLuego noHaySuperficieMasChica(sup, tItem)
                )
            )
        )
    )
...
\pred{noHaySuperficieMasChica}{sup:\ent, t:\toroide}{\\
    (\exists matriz:\matriz{\bool})( esValidaYEstaContenida(matriz) \wedge sup \leq superficie(matriz))}
\vspace{5mm}
...
(|ts| > 0 \yLuego sinRepetidos(ts)) \wedge (\forall i:\ent)(0\leq i < |ts| \implicaLuego \\
...
\aux{cantVivas}{t:toroide}{\ent}{(\sum_{i=0}^{|t|-1} (\sum_{j=0}^{|t[0]|-1} \IfThenElse {t[i][j]}{1}{0}))}
\vspace{5mm}
